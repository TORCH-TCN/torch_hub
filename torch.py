...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", '--directory', help="Path to the directory that contains the images to be analyzed.")
    ...
    parser.add_argument("-o", "--output", nargs='?', default='primary', const='secondary',
    ...
    parser.add_argument("-n", "--no_rename", required=False, action='store_true',
    ...
    parser.add_argument("-j", "--jpeg_rename", nargs='?', default=False, const=JPG_RENAME_STRING,
    ...
    #                 executor=DaskExecutor() if args.parallel else LocalExecutor())
